...
from text_to_vedio_beta import *
...
def get_openai_response():
    ...
    model="gpt-3.5-turbo", 
    messages=[
        {"role": "system", "content": f"你是一個美容產品專員，負責招待客人，讓{string_result}的客人了解{product_result}這項產品"},
...
azure_api_key = "9f613746409945e1847163f216587a24"
azure_region = "eastus"
...
async def recognize_audio():
    ...
    speech_config = speechsdk.SpeechConfig(subscription=azure_api_key, region=azure_region, speech_recognition_language='zh-TW')
...
if __name__== "__main__":
    ...
    agd_parser.add_argument("-fprotp", help='input face proto file path', type=str, default="AGE-Gender-Detection/opencv_face_detector.pbtxt")
    agd_parser.add_argument("-fmodel", help='input face model file path', type=str, default="AGE-Gender-Detection/opencv_face_detector_uint8.pb")
    agd_parser.add_argument("-aprotp", help='input age proto file path', type=str, default="AGE-Gender-Detection/age_deploy.prototxt")
    agd_parser.add_argument("-amodel", help='input age model file path', type=str, default="AGE-Gender-Detection/age_net.caffemodel")
    agd_parser.add_argument("-gprotp", help='input gender proto file path', type=str, default="AGE-Gender-Detection/gender_deploy.prototxt")
    agd_parser.add_argument("-gmodel", help='input gender model file path', type=str, default="AGE-Gender-Detection/gender_net.caffemodel")
    ...
    product_result = choose_product(all_result)
    ...
    model="gpt-3.5-turbo", 
    messages=[
        {"role": "system", "content": "你是一個廣告文案師，請寫一段低少於40字的中文廣告，將" + product_result + "的功效以及好處推薦給" + string_result + "年齡段的消費者"},
    ...
    print(result_url)
    # time.sleep(10)
    # result = get_a_specific_talk(id1, d_id_api)
    # print(result)
    # file_name = download_and_play(result)
    # print(file_name)
